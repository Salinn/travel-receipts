...
export default {
  ...
  table: {
      columns: [
          ...
          { accessor: 'date', label: 'Date', priorityLevel: 3, position: 6, minWidth: 150, sortType: 'date', sortable: false, },
          { accessor: 'reason', label: 'Reason for Purchase', priorityLevel: 8, position: 7, minWidth: 300, sortable: false, },
          { accessor: 'photo', label: 'Photo', priorityLevel: 5, position: 8, minWidth: 200, CustomComponent: Image, sortable: false, },
      ],
      rows: [],
